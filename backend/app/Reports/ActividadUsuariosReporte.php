...
class ActividadUsuariosReporte implements Reporte
{
    ...
    public function generar(array $filtros, bool $paginado = true): ReporteResultadoDTO
    {
        ...
        $conteos = $this->paraEmpresaActual(AuditLog::query())
        ...
        // `User` no filtra por empresa aquí (no hace falta) — los
        // `usuario_id` ya vienen de AuditLog, acotado arriba vía
        // `paraEmpresaActual()`, así que este lookup nunca cruza
