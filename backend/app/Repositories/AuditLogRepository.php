 ...
 * escribe. `TenantScope` (Módulo 2) ya filtra `AuditLog::query()` por
...
class AuditLogRepository
{
    ...
    {
        return AuditLog::query()->distinct()->orderBy('modulo')->pluck('modulo');
    }

    /** @return Collection<int, string> */
    public function accionesDisponibles(): Collection
    {
        return AuditLog::query()->distinct()->orderBy('accion')->pluck('accion');
    }
}
