 ...
 * segunda empresa a escala reducida, solo para probar aislamiento
 * multi-tenant con datos reales (no una fila vacía).
 *
...
class DatabaseSeeder extends Seeder
{
    ...
    private function poblarEmpresa(Empresa $empresa, float $escala, bool $esPrincipal): void
    {
        ...
        // Ambos contextos, no solo uno: TenantContext es lo que TenantScope
        // lee para filtrar (o fail-closed) cada query de este seeder contra
        // modelos empresa-owned; el team id de Spatie protege por separado
        // sus propias consultas internas de roles/permisos.
