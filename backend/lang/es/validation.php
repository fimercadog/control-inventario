...
return [
    ...
    | Laravel. Necesario para que ningún error de validación llegue al
    | frontend en inglés (RC1, "no debe requerir explicación").
    |
    */
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Nombres de campo en español para que los mensajes de arriba se lean
    | de forma natural (ej. "El campo empresa es obligatorio" en vez de
    | "El campo empresa_id es obligatorio").
    |
    */
    ...
    'attributes' => [
        ...
        'marca_detectado' => 'marca',
        'categoria_detectado' => 'categoría',
        'presentacion_detectado' => 'presentación',
        'unidad_detectado' => 'unidad',
