...
class InvitationControllerTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $rolAdmin = Role::create(['name' => 'Administrador', 'guard_name' => 'api', 'empresa_id' => $this->empresaA->id]);
        $rolAdmin->givePermissionTo('usuarios.invitar');
        $this->roleA = Role::create(['name' => 'Bodeguero', 'guard_name' => 'api', 'empresa_id' => $this->empresaA->id]);
        ...
        $this->roleB = Role::create(['name' => 'Rol de Empresa B', 'guard_name' => 'api', 'empresa_id' => $this->empresaB->id]);
        $registrar->forgetCachedPermissions();
