...
class ReporteControllerTest extends TestCase
{
    ...
    public function test_productos_por_categoria_groups_correctly(): void
    {
        ...
        $snacks = Categoria::create(['nombre' => 'Snacks', 'empresa_id' => $this->empresaA->id]);
    ...
    public function test_productos_mas_movidos_ranks_by_movement_count(): void
    {
        ...
        foreach (range(1, 3) as $i) {
            Movimiento::create([
                ...
                'stock_anterior' => $i - 1, 'stock_nuevo' => $i, 'empresa_id' => $this->empresaA->id,
            ]);
        }
        Movimiento::create([
    ...
    {
        Cliente::create(['nombre' => 'Activo Uno', 'estado' => 'activo', 'empresa_id' => $this->empresaA->id]);
        Cliente::create(['nombre' => 'Activo Dos', 'estado' => 'activo', 'empresa_id' => $this->empresaA->id]);
        Cliente::create(['nombre' => 'Inactivo Uno', 'estado' => 'inactivo', 'empresa_id' => $this->empresaA->id]);
    ...
    {
        $principal = Proveedor::create(['nombre' => 'Proveedor Principal', 'estado' => 'activo', 'empresa_id' => $this->empresaA->id]);
        $secundario = Proveedor::create(['nombre' => 'Proveedor Secundario', 'estado' => 'activo', 'empresa_id' => $this->empresaA->id]);
        Proveedor::create(['nombre' => 'Proveedor Inactivo', 'estado' => 'inactivo', 'empresa_id' => $this->empresaA->id]);

        $productoUno = $this->crearProducto();
        $productoDos = $this->crearProducto();

        ProductoProveedor::create(['producto_id' => $productoUno->id, 'proveedor_id' => $principal->id, 'estado' => 'activo', 'empresa_id' => $this->empresaA->id]);
        ProductoProveedor::create(['producto_id' => $productoDos->id, 'proveedor_id' => $principal->id, 'estado' => 'activo', 'empresa_id' => $this->empresaA->id]);
        ProductoProveedor::create(['producto_id' => $productoUno->id, 'proveedor_id' => $secundario->id, 'estado' => 'activo', 'empresa_id' => $this->empresaA->id]);
    ...
    public function test_company_b_data_never_leaks_into_company_as_report(): void
    {
        ...
        $productoB = Producto::create(['nombre' => 'Producto B', 'costo' => 5000, 'stock_minimo' => 0, 'estado' => 'activo', 'empresa_id' => $this->empresaB->id]);
        $productoB->forceFill(['stock_actual' => 999])->save();
        Cliente::create(['nombre' => 'Cliente B', 'estado' => 'activo', 'empresa_id' => $this->empresaB->id]);
        Proveedor::create(['nombre' => 'Proveedor B', 'estado' => 'activo', 'empresa_id' => $this->empresaB->id]);
