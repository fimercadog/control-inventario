...
class RoleControllerTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $rolAuthA = Role::create(['name' => 'Test Auth A', 'guard_name' => 'api']);
        ...
        $rolAuthB = Role::create(['name' => 'Test Auth B', 'guard_name' => 'api']);
    ...
    {
        $role = Role::create(['name' => $name, 'guard_name' => 'api', 'estado' => 'activo']);
        if ($permisos !== []) {
