...
- [x] **Módulo 3 — Authorization (RBAC)** (2026-08-02, corregido en este documento 2026-08-04 — quedó marcado `[ ]` dos días después de completarse): Policies con enforcement real de permiso (AND pertenencia de empresa) en las 9 Policies de recursos de negocio del ERP, sidebar filtrado por permiso (`AppSidebar`, `puedeVerModulo`). Cerrado en dos fases: `docs/05_IMPLEMENTATION/AuthorizationAlignment.md` (Fase 4.5) y `docs/05_IMPLEMENTATION/AuthorizationCompletion.md` (Fase 4.6). Ver `docs/security/ROLES_MATRIX.md` (`Status: Approved — arquitectura de autorización completa`) y `docs/08_ADR/ADR-010-rbac-teams.md`.
...
- [x] **Módulo 6 — Invitaciones** (2026-08-03, corregido en este documento 2026-08-04): invitar usuario (con rol ya existente de Módulo 5) vía `InvitarUsuarioDialog`, aceptar invitación en `/aceptar-invitacion` (pública, resuelve el token antes de mostrar el formulario), reasignación de rol. Ver `docs/03_FUNCTIONAL_SPEC/Users.md` y `docs/05_IMPLEMENTATION/UsersModule.md` §"Ampliación 2026-08-03 — Módulo 6 (Invitaciones) y reasignación de rol".
