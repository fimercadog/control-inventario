...
- Name: categorias.spec.ts >> Categorías list >> Ver opens a modal with the category's real details, not a page navigation
- Location: tests\categorias.spec.ts:77:7
