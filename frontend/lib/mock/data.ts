...
export const MOCK_MOVEMENTS: MockMovement[] = [
  { id: 1, producto: "Dog Chow Adultos", productoImagenColor: "oklch(0.72 0.15 60)", tipo: "entrada", cantidad: 15, fecha: hoursAgo(1), usuario: "Fidel Mercado", origen: "Captura IA", observacion: "Foto de bodega" },
  { id: 2, producto: "Coca Cola", productoImagenColor: "oklch(0.55 0.22 25)", tipo: "entrada", cantidad: 48, fecha: hoursAgo(2), usuario: "Fidel Mercado", origen: "Captura IA", observacion: "Foto + Voz" },
  { id: 3, producto: "NexGard", productoImagenColor: "oklch(0.62 0.2 25)", tipo: "salida", cantidad: 6, fecha: hoursAgo(3), usuario: "Ana Torres", origen: "Captura IA", observacion: "Voz: 'saca seis NexGard'" },
  { id: 4, producto: "Amoxicilina 500mg", productoImagenColor: "oklch(0.65 0.18 300)", tipo: "entrada", cantidad: 4, fecha: hoursAgo(5), usuario: "Fidel Mercado", origen: "Captura IA" },
  ...
  { id: 8, producto: "Pepsi", productoImagenColor: "oklch(0.5 0.2 260)", tipo: "entrada", cantidad: 30, fecha: hoursAgo(14), usuario: "Fidel Mercado", origen: "Captura IA" },
  ...
  { id: 10, producto: "Agua Cristal", productoImagenColor: "oklch(0.75 0.08 220)", tipo: "entrada", cantidad: 60, fecha: hoursAgo(26), usuario: "Fidel Mercado", origen: "Captura IA" },
  ...
  { id: 12, producto: "Cloro", productoImagenColor: "oklch(0.85 0.02 200)", tipo: "entrada", cantidad: 20, fecha: hoursAgo(40), usuario: "Fidel Mercado", origen: "Captura IA" },
