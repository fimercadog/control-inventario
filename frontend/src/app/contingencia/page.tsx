...
export default function ContingenciaPage() {
  ...
  return <div className="mx-auto flex max-w-4xl flex-col gap-6">
    ...
    <Dialog open={productDialogOpen} onOpenChange={setProductDialogOpen}><DialogContent className="sm:max-w-2xl"><DialogHeader className="gap-2 pb-3"><DialogTitle>Crear producto offline</DialogTitle><DialogDescription>Solo texto. El stock inicial seguirá siendo 0; categorías, marcas y unidades se pueden completar posteriormente.</DialogDescription></DialogHeader><form className="grid gap-4 sm:grid-cols-2" onSubmit={enqueue}>
    ...
    <Dialog open={activityDialogOpen} onOpenChange={setActivityDialogOpen}><DialogContent className="sm:max-w-xl"><DialogHeader className="gap-2 pb-3"><DialogTitle>Registrar actividad CRM offline</DialogTitle><DialogDescription>Solo actividades manuales. No modifica oportunidades, etapas, responsables ni automatizaciones.</DialogDescription></DialogHeader><form className="grid gap-4 sm:grid-cols-2" onSubmit={enqueueActivity}>
    ...
    <Dialog open={pendingDialogOpen} onOpenChange={setPendingDialogOpen}><DialogContent className="sm:max-w-2xl"><DialogHeader className="gap-2 pb-3"><DialogTitle>Operaciones pendientes</DialogTitle><DialogDescription>Se procesan individualmente y en el orden en que fueron registradas.</DialogDescription></DialogHeader><div className="flex max-h-[55vh] flex-col gap-3 overflow-y-auto">
