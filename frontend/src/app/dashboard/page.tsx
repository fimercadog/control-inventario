...
const EMPTY_DASHBOARD: DashboardSummary = {
  ...
  crm: { contactos: 0, prospectos: 0, oportunidades_abiertas: 0, valor_pipeline: 0, actividades_pendientes: 0, actividades_vencidas: 0, oportunidades_destacadas: [], proximas_actividades: [] },
};
