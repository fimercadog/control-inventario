...
export function Sidebar() {
  return (
    <aside className="hidden w-68 shrink-0 flex-col border-r border-[#30334e] bg-[#1a1c2e] p-4 text-slate-100 [&_nav_a:not([aria-current=page])]:text-slate-300 [&_nav_a:not([aria-current=page]):hover]:bg-white/8 [&_nav_a:not([aria-current=page]):hover]:text-white [&_nav_span]:text-slate-400 md:flex">
